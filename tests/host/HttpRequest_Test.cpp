...
TEST(HttpRequest, ParsesHeadersCorrectly)
{
    ...
    HttpRequest req(rawHeaders, "POST", "/test");
...
TEST(HttpRequest, ParsesQueryParams)
{
    ...
    HttpRequest req(rawHeaders, "GET", "/api?foo=bar&baz=qux");
...
TEST(HttpRequest, ParsesCookies)
{
    ...
    HttpRequest req(rawHeaders, "GET", "/");
...
{
    const char* rawHeaders = "\r\n";
    HttpRequest req(rawHeaders, "PUT", "/resource?id=123");
...
TEST(HttpRequest, ParsesContentLength)
{
    ...
    HttpRequest req(rawHeaders, "GET", "/test");
...
{
    const char* rawHeaders = "\r\n";
    HttpRequest req(rawHeaders, "GET", "/search?q=hello%20world&lang=en");
...
TEST(HttpRequest, ParsesFormParams)
{
    ...
    HttpRequest req(rawHeaders, "POST", "/submit");
...
TEST(HttpRequest, DetectsMultipart)
{
    ...
    HttpRequest req(rawHeaders, "POST", "/upload");
