...
public:
    ...
    err_t onConnected(void* arg, struct altcp_pcb* conn, err_t err);
...
private:
    ...
    TaskHandle_t connecting_task = nullptr; ///< Task handle for async operations
    ...
    int connectResult = ERR_OK; ///< Result of the last connect attempt
