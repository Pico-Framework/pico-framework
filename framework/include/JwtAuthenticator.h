 ...
 */
 ...
 /**
  * @brief JWT Authenticator for embedded applications.
  * 
 ...
 public:
     /**
      * @brief Get the singleton instance of the Authenticator.
      * @return Reference to the global Authenticator instance.
      */
 ...
 private:
     /**
      * @brief Construct a new Authenticator object.
